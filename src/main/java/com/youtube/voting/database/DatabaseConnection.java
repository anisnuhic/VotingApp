...
public class DatabaseConnection {
    ...
    private static final String USERNAME = "anis"; 
    private static final String PASSWORD = "anis"; 

    private static volatile Connection connection = null;
    private static final Object lock = new Object();
    private static boolean adminTablesCreated = false; 
    ...
    public static Connection getConnection() {
        ...
        // Provjeri da li je konekcija jos uvijek validna
        try {
    ...
    private static void initializeDatabase() {
        try {
            ...
            if (!adminTablesCreated) {
                try {
                    DatabaseUpdate.updateDatabaseSchema();
                    adminTablesCreated = true;
                } catch (Exception e) {
                    System.err.println("⚠️ Warning: Could not create admin tables: " + e.getMessage());
                }
            }
    ...
    private static void insertInitialDataIfEmpty() throws SQLException {
        try (Statement stmt = connection.createStatement()) {
            ...
            if (count == 0) {
                System.out.println("📦 Dodavam početne videje...");
