...
public class DatabaseInitializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            // Forsiraj kreiranje konekcije (sto ce kreirati bazu i tabele)
            DatabaseConnection.getConnection();
            System.out.println("✅ Baza podataka uspješno inicijalizovana!");
            
        } catch (Exception e) {
            System.err.println("❌ GRESKA pri inicijalizaciji baze: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        System.out.println("=== APLIKACIJA UGASENA ===");
    }
}